...
<div class="container-fluid">
    <div class="row ">
        <div class="col-md-12">
            <div class="card">
            <div class="card-header">{{ __('Comentários ') }} <a class="float-right"  href="{{ route('comentarios.index') }}">Voltar <i class="fas fa-hand-point-left"></i></a> </div>
                ...
                {{-- Formulário --}}
                <form role="form" action="{{ route('comentarios.update', $Comentario->id) }}" method="POST" enctype="multipart/form-data"> 
                  {{ csrf_field() }}
                  {{ method_field('PUT') }}
                  
                  @include('painel/Comentario/form')  
