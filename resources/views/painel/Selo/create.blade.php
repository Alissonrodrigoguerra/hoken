...
<div class="container-fluid">
    <div class="row ">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('Novo Selo') }} <a class="float-right" href="{{ route('selo.index', $product->id) }}">Voltar <i class=" fas fa-hand-point-left"></i></a></div>
                ...
                {{-- Formulário --}}
                <form role="form" action="{{ route('selo.store') }}" method="POST" enctype="multipart/form-data"> 
                  {{ csrf_field() }}
