...
<div class="container-fluid">
    <div class="row ">
        <div class="col-md-12">
            <div class="card">
            <div class="card-header">{{ __('duvidas.Atualizar') }} <a class="float-right"  href="{{ route('duvidas.index') }}">Voltar <i class="fas fa-hand-point-left"></i></a> </div>
                ...
                {{-- Formulário --}}
                <form role="form" action="{{ route('duvidas.update', $Duvidas->id) }}" method="POST" enctype="multipart/form-data"> 
                  {{ csrf_field() }}
                  {{ method_field('PUT') }}
                  
                  @include('painel/duvidas.form')  
        ...
        $.ajax({
          ...
          success:function(data) {
            ...
            $(".modal-body").append("<div class='callout callout-success'><h5>Categoria adicionada com sucesso!</h5></div>");
              ...
              $('#categoria_refresh').click(function (e) { 
              e.preventDefault();
              var token = $('input[type=hidden][name=_token]').val();
              ...
              $.ajax({
                  ...
                  $("#categoria_id").append("<option value="+data['id']+">"+data['categoria_title']+"</option>");
      ...
      $('#remover_categoria').click(function (e) { 
          ...
          $.ajax({
            ...
            success:function(data) {
              ...
              // $("#remover_categoria").append("<div class='callout callout-success'><h5>"+data+"</h5></div>");
