...
<div class="container-fluid">
    <div class="row ">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('Novo Manual') }} <a class="float-right" href="{{ route('manual.index') }}">Voltar <i class=" fas fa-hand-point-left"></i></a></div>
                ...
                {{-- Formulário --}}
                <form role="form" action="{{ route('manual.store') }}" method="POST" enctype="multipart/form-data"> 
                  {{ csrf_field() }}
