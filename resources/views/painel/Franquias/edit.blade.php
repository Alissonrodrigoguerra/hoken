...
<div class="container-fluid">
    <div class="row ">
        <div class="col-md-12">
            <div class="card">
            <div class="card-header">{{ __('Franquias Atualizar') }} <a class="float-right"  href="{{ route('franquias.index') }}">Voltar <i class="fas fa-hand-point-left"></i></a> </div>
                ...
                {{-- Formulário --}}
                <form role="form" action="{{ route('franquias.update', $Franquias->id) }}" method="POST" enctype="multipart/form-data"> 
                  {{ csrf_field() }}
                  {{ method_field('PUT') }}
